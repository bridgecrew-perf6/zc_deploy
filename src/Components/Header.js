...
class Header extends React.Component {
    ...
    handleSignup = (event) =>{
       ...
       let {username,password,firstname,lastname, } = this.state;
        ...
        axios({
            ...
            method: 'POST',
            url: 'http://powerful-oasis-00410.herokuapp.com/signup',
    ...
    handleAuth = (event) => {
        ...
        axios({
            ...
            method: 'POST',
            url: 'http://powerful-oasis-00410.herokuapp.com/login',
            headers: { 'Content-Type': 'application/json' },
            data: AuthObj
        }).then(response=>{
    ...
    getOrdersDetails = () => {
        ...
        axios({
            method: 'GET',
            url: `http://powerful-oasis-00410.herokuapp.com/orders/${userId}`,
            headers: { 'Content-Type': 'application/json' }
        })
        .then(response => {
