...
class Details extends React.Component {
    constructor() {
        ...
        this.state = {
            ...
            email: undefined,
            address: undefined,
            placedByUserName: undefined,
            placedByUserId: undefined,
            itemsName : [],
            restData: [],
            restName : undefined,
            placedOn : undefined
    ...
    componentDidMount() {
        ...
        let placedByUserId = sessionStorage.getItem('placedByUserId');

        this.setState({ placedByUserId, restaurant });
    ...
    addItems = (index, operationType) => {
        ...
        let itemsName = this.state.itemsName;
        let total = 0;
        ...
        if (operationType == 'add') {
            ...
            const isInArray = itemsName.includes(item.name);
            if (isInArray == true){}
            else {
            ...
            if (isInArray == true){
                ...
                itemsName = arrayRemove(itemsName,item.name );
        ...
        this.setState({ menuItems: items, subTotal: total,itemsName  });
    ...
    handlePayment = (event) => {
        ...
        const { subTotal, email, name, placedByUserId, restaurant,itemsName,address,contactNumber,restName,placedOn } = this.state;
        

        let OrderObj = {
            placedByUserName:name, 
            placedByUserId, 
            items :itemsName, 
            amount:subTotal, 
            resId:restaurant,
